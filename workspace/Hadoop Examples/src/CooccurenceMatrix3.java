 ...
 * @date 27-03-2013
 */
public class CooccurenceMatrix3 {
	...
	public static class Map extends Mapper<LongWritable, Text, TextPair, IntWritable> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			String word = "", neighbour = "", line = value.toString();
	...
	public static void main(String[] args) throws Exception {
		Job job = new Job();
		job.setJarByClass(CooccurenceMatrix3.class);
		job.setJobName("CooccurenceMatrix - Example 3");
